<template>
  ...
  <a-form layout="inline">
    <a-form-item label="门店">
      <a-input v-model:value="listParm.roomName" placeholder="请输入门店名称"></a-input>
    </a-form-item>
    <a-form-item label="日期">
      <a-input v-model:value="listParm.dateTime" placeholder="请输入日期"></a-input>
    </a-form-item>
  ...
  <Update ref="updateRef" @save="save"></Update>
</template>
<script setup lang='ts'>
import useFlow from '@/composable/PassengerFlow/useFlow';
import Add from './Add.vue';
import useTable from '@/composable/PassengerFlow/useTable';
import Update from "@/views/PassengerFlow/Update.vue";

//表格属性
const { rolePage, listParm, columns, tableHeight, tableList, resetBtn, searchBtn ,getList} = useTable()
//新增、编辑
const { addBtn, editBtn, deleteBtn, addRef, save, updateRef } = useFlow(getList)
</script>
