...
const worldMap = () => import('./components/page1/worldMap.vue');
const ring = () => import('./components/page1/ring.vue');
const popularBar = () => import('./components/page1/popularBar.vue');
const lines = () => import('./components/page1/lines.vue');
const pieRing = () => import('./components/page1/pieRing.vue');
const colorsBar = () => import('./components/page1/colorsBar.vue');
const funnel = () => import('./components/page1/funnel.vue');
const lineBar = () => import('./components/page1/lineBar.vue');
